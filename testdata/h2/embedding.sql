...
INSERT INTO films (title, synopsis_short, synopsis_long)
VALUES ('Film 1', 'Short film 1', 'Long film 1'),
       ('Film 2', 'Short film 2', 'Long film 2'),
       ('Film 3', 'Short film 3', 'Long film 3');


INSERT INTO series (title, synopsis_short, synopsis_long)
VALUES ('Series 1', 'Short series 1', 'Long series 1'),
       ('Series 2', 'Short series 2', 'Long series 2'),
       ('Series 3', 'Short series 3', 'Long series 3');

INSERT INTO episodes2 (title, series_title, synopsis_short, synopsis_long)
VALUES ('S01E01', 'Series 1', 'Short S01E01', 'Long S01E01'),
